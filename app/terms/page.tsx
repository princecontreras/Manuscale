          ...
          <div className="space-y-12 prose prose-slate max-w-none">
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                By accessing or using Typoscale (the "Service"), you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                Permission is granted to use the Typoscale platform for personal or commercial publishing purposes. This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-slate-600">
                <li>Attempt to decompile or reverse engineer any software contained on Typoscale's website;</li>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                The materials on Typoscale's website are provided on an 'as is' basis. Typoscale makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                In no event shall Typoscale or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Typoscale's website, even if Typoscale or a Typoscale authorized representative has been notified orally or in writing of the possibility of such damage.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                These terms and conditions are governed by and construed in accordance with the laws of the jurisdiction in which Typoscale operates, and you irrevocably submit to the exclusive jurisdiction of the courts in that State or location.
              </p>
            </section>
          </div>
        </div>
